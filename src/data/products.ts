...
export const products: Product[] = [
  {
    id: 'dermacare-capsule',
    name: 'Dermacare Capsule',
    shortDescription:
      'Exclusive herbal skin care formulation that nourishes and protects skin from within.',
    description:
      'Dermacare is an exclusive herbal skin care formulation thoughtfully developed by Bilva Wellness to nourish, protect and improve overall skin health from within.',
    image:
...

  {
    ...
    shortDescription:
      'Herbal diabetic support formulation for controlling Type II diabetes.',
    description:
      'Insuwell is an exclusive herbal diabetic support formulation developed by Bilva Wellness to help control blood sugar levels and reduce diabetes-related complications.',
    image:
      'https://images.pexels.com/photos/3830681/pexels-photo-3830681.jpeg?auto=compress&cs=tinysrgb&w=600',
    composition: [
  ...
  {
    id: 'madhu-niyantran-ras',
    name: 'Madhu Niyantran Ras',
    shortDescription:
      'Herbal diabetic management drink supporting healthy blood sugar levels.',
    description:
      'Madhu Niyantran Ras is an exclusive herbal diabetic management drink developed by Bilva Wellness to support blood sugar control, digestion and metabolism.',
    image:
  ...
  {
    id: 'reloxygen-capsule',
    name: 'Reloxygen Capsule',
    shortDescription:
      'Herbal respiratory support formulation for strong and healthy lungs.',
    description:
      'Reloxygen is an exclusive herbal respiratory support formulation developed by Bilva Wellness to purify lungs, improve breathing capacity and strengthen respiratory health.',
    image:
